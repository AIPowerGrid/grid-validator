...
def run_menu() -> int:
    ...
    while True:
        ...
        try:
            ...
            if choice == "2":
                print(CONSOLE_URL)
                print("Linking requires proof of wallet ownership, not just an address.")
            ...
            if result.returncode:
                print(f"Command exited with code {result.returncode}; see the message above.")
            ...
            print("Could not start that action. Check access to the config folder and executable.")

...
attestations, Grid capability fallback, CLI/dashboard behavior, and systemd
...
- `test_prober.py`, `test_attest.py`, `test_main.py` - challenge, evidence, and
  assignment loop.
- `test_grid_client.py` - endpoint/capability contracts and safe fallback.
...
- Test both assignment-bound operation and safe model-routed fallback.

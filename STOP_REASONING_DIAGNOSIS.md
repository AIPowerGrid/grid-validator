...
2. Qualify stop compliance separately from reasoning behavior. Test the same
   request with an explicitly supported non-reasoning mode and retain the
   reasoning-enabled control. Unsupported controls must remain unavailable;

...
| 6. Correctness | [Rollout evidence and delivery tests](ROLLOUT_2026_09.md): real PostgreSQL 14 binding/race/retry tests, strict matching receipts | PostgreSQL 16 release CI and production integration of local fixes; no compensation correctness claim from evidence-row dedup alone |
